...
📑 Na base sobre absenteísmo haviam o registros de 12 hospitais, sendo que o Hospital de Messejana apresentou todos os registros `NA.`
...
df_totais |> 
  ...
  # Linha para a taxa de absenteísmo - adicionar aes(color)
...
Observa-se que o Hospital Geral de Fortaleza e o Hospital José Martiniano de Alencar foram os que apresentaram maiores taxas de abseteímo, com meses ultrapassando 80%, mesmo após a implementação dos disparos por whatsapp. Os demais hospitais possuem taxas por volta de 10% a 20%.
...
Teve-se a ideia de realizar uma comparação entre a quantidade de disparos e a taxa de abseteísmo por mês, porém, notou-se que na base de envios de whatsapp enviada, não possuía valores para todos os meses. Por exemplo: Para o Hospital Geral de Fortaleza, só havia registros de disparos de agendamentos para os meses de março, junho e julho, faltando os meses de abril e maio.
